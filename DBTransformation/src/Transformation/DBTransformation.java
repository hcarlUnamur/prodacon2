    ...
    private void loadCascadFk(String tablename, String columnName){
        try {
            ...
            SQLSelectQuery select2 = new SQLSelectQuery(
                    ...
                    "(REFERENCED_TABLE_NAME IS NOT NULL AND REFERENCED_TABLE_NAME = '"+tablename+"' AND REFERENCED_COLUMN_NAME = '"+columnName+"') OR (TABLE_NAME='"+tablename+"' AND COLUMN_NAME='"+columnName+"' )"
            );
